...
# ------------------------------------------------
# 4. قسم المرفقات والمستندات الرسمية
# ------------------------------------------------
st.markdown("---")
...
if st.button("إنشاء مسودة التقرير (Word) 📝"):
    if not company_name:
        ...
        with st.spinner('⏳ جاري أتمتة الخريطة وتجهيز المستندات في مواقعها... الرجاء الانتظار قليلاً'):
            ...
            context = {
                ...
                # إدراج الصور في مواقعها بدقة عبر InlineImage (بدون طباعة أسماء الملفات)
        ...
        st.success("🎉 تم التقاط الخريطة وتعبئة التقرير وإدراج الصور في مواقعها بنجاح تام!")
        st.download_button(
